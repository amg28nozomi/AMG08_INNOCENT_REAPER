...
namespace inr {
	...
	namespace enemy {
		...
		namespace red {
			...
			namespace big {
				// 各種モーション画像の分割数
				constexpr auto WAKEUP_SIZE = 5;											//!< 起き上がりモーションの総分割数
				constexpr auto IDOL_SIZE = 3;												//!< 待機モーションの総分割数
				constexpr auto MOVE_SIZE = 5;												//!< 移動モーションの総分割数
				constexpr auto ATTACK_SIZE = 5;											//!< 攻撃モーションの総分割数
				constexpr auto HIPDROP_SIZE = 7;										//!< ヒップドロップモーションの総分割数
		...
		namespace blue {
			...
			namespace big {
				...
				constexpr auto WAKEUP_SIZE = 5;											//!< 起き上がりモーションの総分割数
				constexpr auto IDOL_SIZE = 3;												//!< 待機モーションの総分割数
				constexpr auto PATROL_SIZE = 4;											//!< 巡回モーションの総分割数
				constexpr auto ESCAPE_SIZE = 5;											//!< 逃避モーションの総分割数
